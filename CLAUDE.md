...
| **60b** | **NO AR** (18/08, v=67) — dois consertos e um fato novo. **(1) O placeholder que pintou o site de VERMELHO.** O `texture-7.png` que a onda 60 criou para matar o 404 era um base64 que eu colei de memoria como "1x1 transparente": era um pixel **vermelho com alfa 127**. Como os 22 seletores do tema usam `background-size:cover`, esse unico pixel se esticou e pintou a home, os insights, as paginas de lider e o menu de vermelho, **em producao**. Eu havia "conferido" o arquivo checando que era PNG valido e 1x1 — **medi a existencia, nao o efeito**, e a S157 fazia o mesmo. Agora o PNG e **gerado byte a byte** e o script **rele o que gravou**; a **S159** decodifica o pixel de todo placeholder e exige alfa 0 (testada com o pixel vermelho de volta: acusa). **(2) A sede e SAO PAULO, nao o Rio.** Fato novo do Mario: o escritorio e **Av. Ibirapuera, 2033 — conj. 133, Sao Paulo/SP**, nao existe mais escritorio no Rio, e o **CNPJ do Rio segue ativo**. A onda 59 publicou "sede no Rio de Janeiro" no schema, na descricao da Organization e na meta description das 3 homes, seguindo o handoff do Felipe — corrigido nos 3 idiomas. **`foundingDate` = 2012-04-12** (agora e dado conhecido; a onda 59 o omitia de proposito) e **`foundingLocation` continua Rio**, porque a firma nasceu la em 2012 como *Portas Consulting Brasil* — e o campo que explica as mencoes ao Rio sem afirmar sede no Rio. **CEP ficou FORA:** nao temos o novo e nao se inventa. **A politica de privacidade NAO foi tocada:** ali o endereco e o legal, amarrado ao CNPJ que segue ativo — mexer e decisao juridica. A S149 passou a **cobrar** Sao Paulo/SP e o foundingDate, e a proibir CEP inventado. |
